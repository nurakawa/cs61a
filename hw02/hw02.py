...
def accumulate(merger, start, n, term):
    ...
    total = term(n)
    while n > 1:
        total = merger(total, term(n-1))
        n -= 1
    return merger(start, total)
...
def summation_using_accumulate(n, term):
    ...
    """
    "*** YOUR CODE HERE ***"
    return accumulate(merger=add, start=0, n=n, term=term)
...
def product_using_accumulate(n, term):
    ...
    """
    "*** YOUR CODE HERE ***"
    return accumulate(merger=mul, start=1, n=n, term=term)
